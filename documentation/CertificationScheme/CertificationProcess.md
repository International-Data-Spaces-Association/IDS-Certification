...
Core components within the IDS ecosystem shall
...
a certification of the connector is mandatory.
...
-   Before this, an optional consultation can take place between the
   ...
   from the certification body. Especially for new manufacturers this
